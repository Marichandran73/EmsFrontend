...
const AdminSummary = () => {
  return (
    <div className="flex">
      {/* Sidebar Placeholder */}
      <div className="w-64 hidden md:block" /> {/* Keep space for fixed sidebar */}
      ...
      <div className="flex-1 bg-gray-100 p-8 space-y-12">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <SummaryCard icon={<FaUsers />} text="Active Employees" number={25} />
            <SummaryCard icon={<FaBuilding />} text="Total Departments" number={5} />
            <SummaryCard icon={<CiMoneyCheck1 />} text="Salary" number="$20,0000" />
          </div>
        </div>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
    ...
    <SummaryCard icon={<IoIosCloudDone />} text="Leave Approved" number={4} />
    <SummaryCard icon={<MdPendingActions />} text="Leave Pending" number={5} />
    <SummaryCard icon={<MdCancel />} text="Leave Rejected" number={3} />
  </div>
</div>
        </div>
      </div>
