...
const AddEmployee = () => {
  ...
  <>
    {loading ? (
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 bg-white rounded-lg shadow-lg mt-10 max-h-[80vh] overflow-y-auto">
        ...
        >
          ...
          <div className="md:col-span-2 text-center">
            <button
              type="submit"
              className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-md font-semibold shadow-md w-full sm:w-auto"
            >
              Save Employee
            </button>
          </div>
